...
class ClassificationMeasurements(object):
    ...
    dtype: datasets type (Default: numpy.int64)
        The datasets type of the existing labels.
    ...
    def get_bacc_score(self):
        """ Compute the balanced accuracy of the classifier. Binary-classification only.
    ...
    def get_specificity(self):
        """ compute the specificity of the classifier. Binary-classification only.
    ...
    def get_info(self):
        return '{}:'.format(type(self).__name__) + \
               ...
               ' - balanced_accuracy: {:.6f}'.format(self.get_bacc_score()) + \
               ...
               ' - specificity: {:.6f}'.format(self.get_specificity()) + \
