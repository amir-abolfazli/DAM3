class EvaluationDataBuffer(object):
    """ Stores evaluation datasets at a given time. It is used to track and distribute
    datasets across evaluators and visualizers.
    """
    ...
    def __init__(self, data_dict):
        ...
        ----------
        data_dict: dict
            Dictionary containing metrics as keys and datasets identifiers as values.
