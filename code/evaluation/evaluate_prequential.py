...
class EvaluatePrequential(StreamEvaluator):
    ...
    data_points_for_classification: bool(Default: False)
        If True, the visualization used is a cloud of datasets points (only works for classification)
    ...
    >>> from skmultiflow.datasets import SEAGenerator
    ...
    >>> # and visualize the predictions using datasets points.
    ...
    def _train_and_test(self):
        ...
        # Flush file buffer, in case it contains datasets
    ...
    def partial_fit(self, X, y, classes=None, sample_weight=None):
        """ Partially fit all the models on the given datasets.

        Parameters
        ----------
        X: Numpy.ndarray of shape (n_samples, n_features)
            The datasets upon which the algorithm will create its model.
